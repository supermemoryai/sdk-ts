...
```sh
npm install git+ssh://git@github.com:stainless-sdks/supermemory-new-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/supermemory-new-typescript/issues) with questions, bugs, or suggestions.
