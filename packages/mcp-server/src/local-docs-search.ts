...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; activeContentUpdateId: string; connectionId: string; content: string; createdAt: string; customId: string; dreamingStatus: 'dreaming' | 'done'; filepath: string; latestRevision: number; metadata: string | number | boolean | object | object[]; ogImage: string; raw: object; source: string; status: 'unknown' | 'queued' | 'extracting' | 'chunking' | 'embedding' | 'indexing' | 'done' | 'failed'; summary: string; taskType: 'memory' | 'superrag'; title: string; tombstonedAt: string; type: string; updatedAt: string; containerTags?: string[]; memories?: { id: string; createdAt: string; isForgotten: boolean; isInference: boolean; isLatest: boolean; isStatic: boolean; memory: string; metadata: string | number | boolean | object | object[]; parentMemoryId: string; rootMemoryId: string; sourceCount: number; updatedAt: string; version: number; }[]; url?: string; }",
    markdown:
      "## get\n\n`client.documents.get(id: string): { id: string; activeContentUpdateId: string; connectionId: string; content: string; createdAt: string; customId: string; dreamingStatus: 'dreaming' | 'done'; filepath: string; latestRevision: number; metadata: string | number | boolean | object | object[]; ogImage: string; raw: object; source: string; status: 'unknown' | 'queued' | 'extracting' | 'chunking' | 'embedding' | 'indexing' | 'done' | 'failed'; summary: string; taskType: 'memory' | 'superrag'; title: string; tombstonedAt: string; type: string; updatedAt: string; containerTags?: string[]; memories?: object[]; url?: string; }`\n\n**get** `/v3/documents/{id}`\n\nGet a document by ID\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; activeContentUpdateId: string; connectionId: string; content: string; createdAt: string; customId: string; dreamingStatus: 'dreaming' | 'done'; filepath: string; latestRevision: number; metadata: string | number | boolean | object | object[]; ogImage: string; raw: object; source: string; status: 'unknown' | 'queued' | 'extracting' | 'chunking' | 'embedding' | 'indexing' | 'done' | 'failed'; summary: string; taskType: 'memory' | 'superrag'; title: string; tombstonedAt: string; type: string; updatedAt: string; containerTags?: string[]; memories?: { id: string; createdAt: string; isForgotten: boolean; isInference: boolean; isLatest: boolean; isStatic: boolean; memory: string; metadata: string | number | boolean | object | object[]; parentMemoryId: string; rootMemoryId: string; sourceCount: number; updatedAt: string; version: number; }[]; url?: string; }`\n\n  - `id: string`\n  - `activeContentUpdateId: string`\n  - `connectionId: string`\n  - `content: string`\n  - `createdAt: string`\n  - `customId: string`\n  - `dreamingStatus: 'dreaming' | 'done'`\n  - `filepath: string`\n  - `latestRevision: number`\n  - `metadata: string | number | boolean | object | object[]`\n  - `ogImage: string`\n  - `raw: object`\n  - `source: string`\n  - `status: 'unknown' | 'queued' | 'extracting' | 'chunking' | 'embedding' | 'indexing' | 'done' | 'failed'`\n  - `summary: string`\n  - `taskType: 'memory' | 'superrag'`\n  - `title: string`\n  - `tombstonedAt: string`\n  - `type: string`\n  - `updatedAt: string`\n  - `containerTags?: string[]`\n  - `memories?: { id: string; createdAt: string; isForgotten: boolean; isInference: boolean; isLatest: boolean; isStatic: boolean; memory: string; metadata: string | number | boolean | object | object[]; parentMemoryId: string; rootMemoryId: string; sourceCount: number; updatedAt: string; version: number; }[]`\n  - `url?: string`\n\n### Example\n\n```typescript\nimport Supermemory from 'supermemory';\n\nconst client = new Supermemory();\n\nconst document = await client.documents.get('id');\n\nconsole.log(document);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    markdown:
      "## update\n\n`client.settings.update(chunkSize?: number, excludeItems?: string | number | boolean | object | object[], filterPrompt?: string, githubClientId?: string, githubClientSecret?: string, githubCustomKeyEnabled?: boolean, googleDriveClientId?: string, googleDriveClientSecret?: string, googleDriveCustomKeyEnabled?: boolean, includeItems?: string | number | boolean | object | object[], notionClientId?: string, notionClientSecret?: string, notionCustomKeyEnabled?: boolean, onedriveClientId?: string, onedriveClientSecret?: string, onedriveCustomKeyEnabled?: boolean, profileBuckets?: { key: string; description?: string; }[], shouldLLMFilter?: boolean): { orgId: string; orgSlug: string; updated: object; }`\n\n**patch** `/v3/settings`\n\nUpdate settings for an organization\n\n### Parameters\n\n- `chunkSize?: number`\n\n- `excludeItems?: string | number | boolean | object | object[]`\n\n- `filterPrompt?: string`\n\n- `githubClientId?: string`\n\n- `githubClientSecret?: string`\n\n- `githubCustomKeyEnabled?: boolean`\n\n- `googleDriveClientId?: string`\n\n- `googleDriveClientSecret?: string`\n\n- `googleDriveCustomKeyEnabled?: boolean`\n\n- `includeItems?: string | number | boolean | object | object[]`\n\n- `notionClientId?: string`\n\n- `notionClientSecret?: string`\n\n- `notionCustomKeyEnabled?: boolean`\n\n- `onedriveClientId?: string`\n\n- `onedriveClientSecret?: string`\n\n- `onedriveCustomKeyEnabled?: boolean`\n\n- `profileBuckets?: { key: string; description?: string; }[]`\n  Profile bucket definitions\n\n- `shouldLLMFilter?: boolean`\n\n### Returns\n\n- `{ orgId: string; orgSlug: string; updated: { chunkSize?: number; excludeItems?: string | number | boolean | object | object[]; filterPrompt?: string; githubClientId?: string; githubClientSecret?: string; githubCustomKeyEnabled?: boolean; googleDriveClientId?: string; googleDriveClientSecret?: string; googleDriveCustomKeyEnabled?: boolean; includeItems?: string | number | boolean | object | object[]; notionClientId?: string; notionClientSecret?: string; notionCustomKeyEnabled?: boolean; onedriveClientId?: string; onedriveClientSecret?: string; onedriveCustomKeyEnabled?: boolean; profileBuckets?: { key: string; description?: string; }[]; shouldLLMFilter?: boolean; }; }`\n\n  - `orgId: string`\n  - `orgSlug: string`\n  - `updated: { chunkSize?: number; excludeItems?: string | number | boolean | object | object[]; filterPrompt?: string; githubClientId?: string; githubClientSecret?: string; githubCustomKeyEnabled?: boolean; googleDriveClientId?: string; googleDriveClientSecret?: string; googleDriveCustomKeyEnabled?: boolean; includeItems?: string | number | boolean | object | object[]; notionClientId?: string; notionClientSecret?: string; notionCustomKeyEnabled?: boolean; onedriveClientId?: string; onedriveClientSecret?: string; onedriveCustomKeyEnabled?: boolean; profileBuckets?: { key: string; description?: string; }[]; shouldLLMFilter?: boolean; }`\n\n### Example\n\n```typescript\nimport Supermemory from 'supermemory';\n\nconst client = new Supermemory();\n\nconst setting = await client.settings.update();\n\nconsole.log(setting);\n```",
    perLanguage: {
      typescript: {
