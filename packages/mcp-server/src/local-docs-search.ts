...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      "documents: { content: string; containerTag?: string; containerTags?: string[]; customId?: string; filepath?: string; filterByMetadata?: object; metadata?: object; taskType?: 'memory' | 'superrag'; }[] | string[];",
      'containerTag?: string;',
      'containerTags?: string[];',
      'content?: null;',
      'filepath?: string;',
