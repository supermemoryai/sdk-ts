...
import { ClientOptions } from 'supermemory';
...
export { ClientOptions } from 'supermemory';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/supermemory-new',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the supermemory-new MCP server. You will use Code Mode to help the user perform
