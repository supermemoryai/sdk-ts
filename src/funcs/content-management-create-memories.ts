 ...
 */
export function contentManagementCreateMemories(
  client: SupermemoryCore,
  request: operations.PostV4MemoriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostV4MemoriesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PostV4MemoriesRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.PostV4MemoriesResponse$inboundSchema),
