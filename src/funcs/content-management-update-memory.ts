 ...
 */
export function contentManagementUpdateMemory(
  client: SupermemoryCore,
  request: operations.PatchV4MemoriesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PatchV4MemoriesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.PatchV4MemoriesRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PatchV4MemoriesResponse$inboundSchema),
