 ...
 */
export function settingsResetOrganizationData(
  client: SupermemoryCore,
  request: operations.PostV3SettingsResetRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostV3SettingsResetResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.PostV3SettingsResetRequest$outboundSchema, value),
  ...
  const path = pathToFunc("/v3/settings/reset")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PostV3SettingsResetResponse$inboundSchema),
