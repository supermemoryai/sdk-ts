 ...
 */
export function connectionsDeleteByProvider(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteV3ConnectionsByProviderRequest$outboundSchema,
        value,
      ),
  ...
  const context = {
    ...
    operationID: "deleteV3ConnectionsByProvider",
    oAuth2Scopes: null,
