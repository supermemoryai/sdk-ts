 ...
 */
export function connectionsDeleteV3ConnectionsByConnectionId(
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.DeleteV3ConnectionsByConnectionIdRequest$outboundSchema,
        value,
      ),
  ...
  const query = encodeFormQuery({
    "deleteDocuments": payload.deleteDocuments,
  });
