 ...
 * @generated-id: 76d80442d569
 */

import { ResponseValidationError } from "../models/errors/response-validation-error.js";
import { SupermemoryDefaultError } from "../models/errors/supermemory-default-error.js";
...
export function match<T, E>(
...
): MatchFunc<T, E | SupermemoryDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<T, E | SupermemoryDefaultError | ResponseValidationError>,
      raw: unknown,
    ]
  > {
    let raw: unknown;
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new SupermemoryDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new SupermemoryDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
