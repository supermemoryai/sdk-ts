...
```typescript
import { PostV4SearchDocument } from "supermemory/models/operations";

let value: PostV4SearchDocument = {
  id: "doc_xyz789",
  ...
  createdAt: "2024-12-31T10:42:00.658Z",
  updatedAt: "2024-12-31T21:04:04.078Z",
};
```
