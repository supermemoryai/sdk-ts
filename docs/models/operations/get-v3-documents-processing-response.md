...
| `pagination`                                                                                                       | [operations.GetV3DocumentsProcessingPagination](../../models/operations/get-v3-documents-processing-pagination.md) | :heavy_minus_sign:                                                                                                 | Present when `view=all`                                                                                            | {<br/>"currentPage": 1,<br/>"limit": 10,<br/>"totalItems": 100,<br/>"totalPages": 10<br/>}                         |