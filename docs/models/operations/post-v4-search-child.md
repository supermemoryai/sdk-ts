...
```typescript
import { PostV4SearchChild } from "supermemory/models/operations";

let value: PostV4SearchChild = {
  relation: "extends",
  version: 1,
  memory:
    "Later version: API rate limit increased to 100 req/min on the free tier.",
  updatedAt: "2024-12-31T02:29:12.091Z",
};
```
...
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| `relation`                                                                                        | [operations.PostV4SearchChildRelation](../../models/operations/post-v4-search-child-relation.md)  | :heavy_check_mark:                                                                                | Relation type between this memory and its parent/child                                            | extends                                                                                           |
