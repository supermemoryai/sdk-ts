...
| `context`                                                                                               | [operations.Context](../../models/operations/context.md)                                                | :heavy_minus_sign:                                                                                      | Object containing version history (parents/children via updates) and related memories (extends/derives) |                                                                                                         |
