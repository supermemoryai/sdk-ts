...
```typescript
import { PatchV3ContainerTagsByContainerTagProfileBucketRequest } from "supermemory/models/operations";

let value: PatchV3ContainerTagsByContainerTagProfileBucketRequest = {
  key: "<key>",
};
```
